---
sidebar: sidebar 
permalink: xcp/xcp-bp-specific-date.html 
keywords: copy, specific date 
summary: Diese Lösung basiert auf einem Kunden, der Daten basierend auf einem bestimmten Datum kopieren muss. 
---
= Spezifisches datumsbasiertes Scannen und Kopieren von Daten
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Diese Lösung basiert auf einem Kunden, der Daten basierend auf einem bestimmten Datum kopieren muss.  Überprüfen Sie die folgenden Details:
